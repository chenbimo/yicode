            ...
            w = {
                ...
                onMenuShareTimeline: function (e) {
                    P(
                        ...
                        {
                            complete: function () {
                                M('shareTimeline', { title: e.title || t, desc: e.title || t, img_url: e.imgUrl || '', link: e.link || location.href, type: e.type || 'link', data_url: e.dataUrl || '' }, e);
                            }
                        },
                        e
                    );
                ...
                onMenuShareAppMessage: function (n) {
                    P(
                        ...
                        {
                            complete: function (e) {
                                'favorite' === e.scene ? M('sendAppMessage', { title: n.title || t, desc: n.desc || '', link: n.link || location.href, img_url: n.imgUrl || '', type: n.type || 'link', data_url: n.dataUrl || '' }) : M('sendAppMessage', { title: n.title || t, desc: n.desc || '', link: n.link || location.href, img_url: n.imgUrl || '', type: n.type || 'link', data_url: n.dataUrl || '' }, n);
                            }
                        },
                        n
                    );
                ...
                openLocation: function (e) {
                    M('openLocation', { latitude: e.latitude, longitude: e.longitude, name: e.name || '', address: e.address || '', scale: e.scale || 28, infoUrl: e.infoUrl || '' }, e);
                },
                getLocation: function (e) {
                    M(
                        c.getLocation,
                ...
                chooseCard: function (e) {
                    M(
                        'chooseCard',
                        { app_id: v.appId, location_id: e.shopId || '', sign_type: e.signType || 'SHA1', card_id: e.cardId || '', card_type: e.cardType || '', card_sign: e.cardSign, time_stamp: e.timestamp + '', nonce_str: e.nonceStr },
                        ((e._complete = function (e) {
